...
actuator_color = [ 0.9, 0.9, 0.9 ];

module actuator_nut()
{
    spec = [
        [ "system", "ISO" ], [ "type", "nut_info" ], [ "shape", "hex" ], [ "pitch", 0.75 ], [ "width", 14 ],
        [ "diameter", 12 ], [ "thickness", 2 ]
    ];
...
module actuator()
{
    ...
    color(actuator_color) union()
    {
        ...
        up(2.5) cyl(l = 5, d = 14, texture = "ribs", tex_depth = 0.1, tex_size = [ 0.3, 0.3 ]);
